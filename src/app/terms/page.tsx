      ...
      <div className="mx-auto max-w-[760px] px-6 py-16">
        ...
        <div className="flex flex-col gap-8 leading-[1.7] text-white/80">
          ...
          <section>
            ...
            <p>TO THE MAXIMUM EXTENT PERMITTED BY LAW, OBSERVER SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, OR CONSEQUENTIAL DAMAGES ARISING FROM YOUR USE OF THE SERVICE. OUR TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT YOU PAID US IN THE PAST 12 MONTHS.</p>
          </section>
