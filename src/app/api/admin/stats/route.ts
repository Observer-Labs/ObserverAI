...
export async function GET() {
  ...
  const [
    ...
    db.from("workspaces").select("id, name, plan, analysis_count, created_at, trial_ends_at, polar_status").order("created_at", { ascending: false }).limit(50),
